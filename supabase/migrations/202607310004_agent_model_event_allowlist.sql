-- Keep the database event validator aligned with the public Agent model
-- catalog. Legacy aliases remain accepted so existing event rows and rolling
-- deployments continue to satisfy the immutable CHECK constraint.
