...
export function serializeAvery5260LabelHtml(
  ...
  return [
    ...
    ".avery-label { width: 2.625in; height: 1in; padding: 0.0625in 0.08in; border: 0; display: flex; flex-direction: column; align-items: center; justify-content: flex-start; overflow: hidden; break-inside: avoid; page-break-inside: avoid; }",
    ".label-heading { color: #d84a32; font-size: 7pt; font-weight: 900; line-height: 1; }",
    ".label-code { margin: 0.014in 0 0.005in; font-family: 'SFMono-Regular', Menlo, Monaco, Consolas, 'Liberation Mono', monospace; font-size: 18.5pt; font-weight: 900; line-height: 1; white-space: nowrap; }",
    ".label-rule { font-size: 7pt; font-weight: 800; line-height: 1; white-space: nowrap; }",
    ".label-reference { margin-top: 0.006in; font-family: 'SFMono-Regular', Menlo, Monaco, Consolas, 'Liberation Mono', monospace; font-size: 7pt; font-weight: 700; line-height: 1; white-space: nowrap; }",
    ".custody-warning, .sample-marker { margin-top: 0.006in; font-size: 7pt; font-weight: 900; line-height: 1; white-space: nowrap; }",
    ".custody-warning { color: #667868; }",
    ".sample-label { background: #fffaf0; }",
