...
| Current private 500-card batch | 500 active eligible rows; exact database hash parity; zero identity overlap with the retired test batch; 500/500 HTML and final 63-page Letter-PDF raster QR decode; mode-0700/0600 ignored custody; idempotent create/activate replay; zero admin profiles at rest | digital validity does not prove physical concealment, print registration, store-lighting scans, staff training, soft-test completion, rights approval, or custody approval |
